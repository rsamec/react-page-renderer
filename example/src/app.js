	...
	render: function() {
		...
		return (
			<div>
				...
				<HtmlPagesRenderer widgets={widgets} schema={printSchema} dataContext={dataContext} errorFlag={false} />
			</div>
		)
	}
});
